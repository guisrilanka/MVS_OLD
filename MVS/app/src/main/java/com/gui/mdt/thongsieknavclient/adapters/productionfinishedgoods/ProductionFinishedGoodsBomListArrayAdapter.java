 ...
 */
public class ProductionFinishedGoodsBomListArrayAdapter extends ArrayAdapter<ProductionOrderBomListResultData> implements Filterable {
    Context context;
    ...
    public ProductionFinishedGoodsBomListArrayAdapter(Context c, ArrayList<ProductionOrderBomListResultData> dataSource) {
