...
public class ApiMobileSalesOrderLineResponse {
    String bookMarkKey;
    List<MobileSalesOrderLineListResultData> MobileSalesOrderLineListResultData;
    ...
    public List<ApiMobileSalesOrderLineResponse.MobileSalesOrderLineListResultData>
    getMobileSalesOrderLineListResultData() {
        return MobileSalesOrderLineListResultData;
    }

    public void setMobileSalesOrderLineListResultData(List<ApiMobileSalesOrderLineResponse
            .MobileSalesOrderLineListResultData> mobileSalesOrderLineListResultData) {
        MobileSalesOrderLineListResultData = mobileSalesOrderLineListResultData;
    }

    public class MobileSalesOrderLineListResultData{
        String Key;         //""
