...
public class MvsStockRequestItemActivity extends AppCompatActivity {
    Toolbar myToolbar;
    ArrayList<MsoSalesOrder> dataModels;
    String description, uom, unitprice, QTy, warehouseqty, Total, itemNo,SalesQTY,VehicleQTY;
    EditText txtItemDesc, txtUOM, txtUnitPrice, txtQTY, txtWarehouseQTY, txtTotalPrice,txtSalesQTY,txtVehicleQTY;
    TextView tvSalesitem;
    Button btnadd;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mvs_stock_request_item);
        ...
        txtSalesQTY=(EditText) findViewById(R.id.txtSalesQTY);
        ...
        SalesQTY = extras.getString("QTY");
        VehicleQTY = extras.getString("QTY");
        ...
        txtSalesQTY.setText(QTy);
        txtVehicleQTY.setText(QTy);
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MvsStockRequestItemActivity.this,"Item Added",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
