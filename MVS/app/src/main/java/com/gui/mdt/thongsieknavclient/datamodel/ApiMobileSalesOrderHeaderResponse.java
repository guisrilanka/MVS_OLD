...
public class ApiMobileSalesOrderHeaderResponse {

    List<ApiMobileSalesOrder> MobileSalesOrderHeaderResultData;
    public String ServerDate;
    public String LastModifiedDate;

    public List<ApiMobileSalesOrder> getMobileSalesOrderHeaderResultData() {
        return MobileSalesOrderHeaderResultData;
    }

    public void setMobileSalesOrderHeaderResultData(List<ApiMobileSalesOrder> mobileSalesOrderHeaderResultData) {
        MobileSalesOrderHeaderResultData = mobileSalesOrderHeaderResultData;
    }
    ...
    public class ApiMobileSalesOrder{
        String Key;   //key
