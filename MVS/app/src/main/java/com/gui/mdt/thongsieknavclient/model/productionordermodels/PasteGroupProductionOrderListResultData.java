 ...
 */
public class PasteGroupProductionOrderListResultData {
    ...
    public PasteGroupProductionOrderListResultData(PasteGroupProductionOrderListResultData targetData)
    {
        ...
        //this.ExpiryDate = targetData.getExpiryDate();
