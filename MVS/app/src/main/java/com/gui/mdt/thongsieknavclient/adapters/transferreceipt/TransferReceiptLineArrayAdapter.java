 ...
 */
public class TransferReceiptLineArrayAdapter extends ArrayAdapter<TransferReceiptLineData> {

    Context context;

    ArrayList<TransferReceiptLineData> dataArray;

    ArrayAdapter<TransferReceiptLineData> adapter;

    public TransferReceiptLineArrayAdapter(Context c, ArrayList<TransferReceiptLineData> dataSource) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(dataArray.get(position) != null) {
            ...
            viewHolder.lblShipQuantity.setText("Qty to Rec: " + dataArray.get(position).getQuantityToReceive());
            ...
            if(!dataArray.get(position).getOrderQuantity().equals("0.0"))
            {
...
*/
    ...
    @Override
    public TransferReceiptLineData getItem(int position) {
