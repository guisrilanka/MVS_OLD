...
public class StockTakeAddNewLineEntry extends SugarRecord{
    ...
    public StockTakeAddNewLineEntry() {
    }

    public StockTakeAddNewLineEntry(String docNo, String itemNo, int lineNo, String productionDate, String expiryDate, String qtyToShip, String lotNumber, String barcodeSerialNo, String serialNo, boolean isScanned, int entryIndexNo, boolean isUploaded, Long timeStamp) {
        DocNo = docNo;
        ItemNo = itemNo;
        LineNo = lineNo;
