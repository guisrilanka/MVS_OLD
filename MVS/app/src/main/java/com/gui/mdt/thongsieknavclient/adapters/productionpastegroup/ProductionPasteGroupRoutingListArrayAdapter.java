...
import com.gui.mdt.thongsieknavclient.ui.ProductionPasteGroupRoutingLotEntryActivity;
 ...
 */
public class ProductionPasteGroupRoutingListArrayAdapter extends ArrayAdapter<PasteGroupProductionOrderRoutingListResultData> implements Filterable {
    Context context;
    ...
    public ProductionPasteGroupRoutingListArrayAdapter(Context c, ArrayList<PasteGroupProductionOrderRoutingListResultData> dataSource) {
        ...
        if (filteredArray.get(position) != null) {
            ...
            viewHolder.btnStart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    viewHolder.btnStart.setVisibility(View.GONE);
                    viewHolder.btnClose.setVisibility(View.GONE);
                    ((ProductionPasteGroupRoutingActivity) context).startRoute(filteredArray.get(position).getOperationNo());
                }
            });
            ...
            viewHolder.btnEnd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    viewHolder.btnEnd.setVisibility(View.GONE);
                    viewHolder.btnClose.setVisibility(View.GONE);
                    ((ProductionPasteGroupRoutingActivity) context).endRoute(filteredArray.get(position).getOperationNo(), 0.0f, 0.0f);
                }
            });
                ...
                public void onClick(View view) {
                    ...
                    if (filteredArray.get(position).isLastRoute()) {
                        if (filteredArray.get(position).isItemTrackingRequired()) {
                            ...
                            Intent intent = new Intent(context, ProductionPasteGroupRoutingLotEntryActivity.class);
                            ...
                            btnSave.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if (quantity.length() != 0 && editScrapQuantity.getText().toString().length() != 0) {
                                        ...
                                        ((ProductionPasteGroupRoutingActivity) context).updateQuantity(filteredArray.get(position).getOperationNo(), outputQuantity, scrapQuantity);
                                        dialog.dismiss();
                                    } else {
