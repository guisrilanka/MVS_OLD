...
public class StockTakeEntryResultData {
    ...
    public StockTakeEntryResultData(int stockTakeEntryLineNo, String itemNo, String postingDate, String locationCode, String binCode, String description, float quantityPhysical, float quantityCalculated, String uom, boolean isItemTrackingRequired, boolean isItemLotTrackingRequired, boolean isItemExpireDateRequired, boolean isItemProductionDateRequired, boolean isItemSNRequired) {
