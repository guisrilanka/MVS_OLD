...
import com.gui.mdt.thongsieknavclient.ui.ProductionPasteGroupBOMLotEntryActivity;
 ...
 */
public class ProductionPasteGroupBomLotEntryListArrayAdapter extends ArrayAdapter<ProductionOrderEntry> {
    Context context;
    ...
    public ProductionPasteGroupBomLotEntryListArrayAdapter(Context c, ArrayList<ProductionOrderEntry> dataSource) {
                            ...
                            .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    ...
                                    if(dataArray.get(position).IsUploaded)
                                    {
                                        ...
                                        ((ProductionPasteGroupBOMLotEntryActivity) context).RemoveEntry(position, dataArray.get(position).ServerEntryIndexNo, dataArray.get(position).LotNo, Float.parseFloat(dataArray.get(position).QtyToConsume));
                                    }
                                    else
                                    {
                                        ...
                                        if(entryList.size() == 1)
                                        {
                                            ...
                                            ((ProductionPasteGroupBOMLotEntryActivity) context).RemoveSerialEntry(temp_lotNo);
                                        }
                                        else
                                        {
