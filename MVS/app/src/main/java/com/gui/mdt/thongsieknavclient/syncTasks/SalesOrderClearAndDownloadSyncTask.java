...
/**
 * Created by nelin_000 on 11/15/2017.
 */

public class SalesOrderClearAndDownloadSyncTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public SalesOrderClearAndDownloadSyncTask(Context context, boolean isForcedSync,boolean isInitialSync) {
        ...
        mLocationName = SalesOrderClearAndDownloadSyncTask.class.getSimpleName();
    }
