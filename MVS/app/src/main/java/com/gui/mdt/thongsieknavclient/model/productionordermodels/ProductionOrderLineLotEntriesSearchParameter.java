 ...
 */
public class ProductionOrderLineLotEntriesSearchParameter {
    ...
    public ProductionOrderLineLotEntriesSearchParameter(String userCompany, String userName, String password, String productionOrderNo, int productionOrderLineNo, int lineNo) {
