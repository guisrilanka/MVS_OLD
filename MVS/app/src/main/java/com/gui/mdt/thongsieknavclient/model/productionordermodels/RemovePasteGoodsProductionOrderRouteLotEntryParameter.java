...
public class RemovePasteGoodsProductionOrderRouteLotEntryParameter {
    ...
    public RemovePasteGoodsProductionOrderRouteLotEntryParameter(String userCompany, String userName, String password, String productionOrderNo, int lineNo, String operationNo, String lotSerialNo, Float quantityToDeduct) {
