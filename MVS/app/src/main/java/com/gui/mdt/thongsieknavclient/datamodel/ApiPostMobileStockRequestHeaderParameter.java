...
public class ApiPostMobileStockRequestHeaderParameter {
    ...
    public ApiPostMobileStockRequestHeaderParameter(String userCompany, String userName, String password) {
        UserCompany = userCompany;
        UserName = userName;
        Password = password;
    }

    public ApiPostMobileStockRequestHeaderParameter() {
