...
public class PasteGroupProductionOrderLinePrintLabelParameter {
    ...
    public PasteGroupProductionOrderLinePrintLabelParameter(FinishedGoodsProductionOrderListResultData targetData)
    {
