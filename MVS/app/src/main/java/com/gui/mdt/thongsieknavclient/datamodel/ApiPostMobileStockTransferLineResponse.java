...
public class ApiPostMobileStockTransferLineResponse {
    public String ServerDate;
    public List<StockTransferLineResponse> trStatusList;
    public int Status;
    ...
    public List<StockTransferLineResponse> getTrStatusList() {
        return trStatusList;
    }

    public void setTrStatusList(List<StockTransferLineResponse> trStatusList) {
    ...
    private class StockTransferLineResponse {
