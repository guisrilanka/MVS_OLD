...
public class QueryItemReclassItemParameters {
    ...
    public QueryItemReclassItemParameters(String userCompany, String userName, String password, String itemNo, int itemReclassLineNo) {
